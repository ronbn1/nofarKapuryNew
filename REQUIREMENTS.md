...
- Implemented testimonials: three short excerpts from reviews marked as verified by mit4mit. Every card contains a photo uploaded with that review, the client's first name and a direct link to the full source review. The section appears directly after the portfolio and becomes a swipe carousel on mobile. No changing aggregate rating is displayed.
