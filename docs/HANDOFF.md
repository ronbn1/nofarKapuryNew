...
- האינדוקס הופעל ב־Cloudflare. עמוד הבית פתוח לאינדוקס ומפת האתר זמינה. עמודי הפרטיות והנגישות מוגדרים `noindex, follow` ואינם נכללים במפה.

הצעדים הבאים:

1. להעלות את ההפרדה בין עמוד הבית המיועד לאינדוקס לבין העמודים המשפטיים המוגדרים `noindex, follow`.
...
3. נכס הדומיין אומת ב־Search Console. לאחר הפריסה הבאה לשלוח את מפת האתר ולבקש אינדוקס רק לעמוד הבית.
